          ...
          >
            ...
            >
              <div className="relative bg-white dark:bg-gray-900 rounded-xl sm:rounded-2xl p-2 sm:p-4 lg:p-6 shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                {/* Keyboard Layout */}
                <div className="space-y-1 sm:space-y-2 md:space-y-3 overflow-x-auto">
                  {keyboardLayout.map((row, rowIndex) => (
                    <div key={rowIndex} className="flex justify-center space-x-0.5 sm:space-x-1 md:space-x-2 min-w-max px-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-6xl mx-auto">
            {Object.entries(skillsData).map(([categoryKey, category]) => {
              ...
              return (
                <div
                  key={categoryKey}
                  className="relative h-48 sm:h-56 md:h-64 lg:h-72 cursor-pointer group"
